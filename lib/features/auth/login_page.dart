    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            const Text(
                "Entrez votre téléphone pour recevoir un nouveau code.",
            ...
            TextField(
              ...
              decoration:
              _inputDecoration("Téléphone", Icons.phone_android),
            ),
          ],
        ),
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              setState(() => _isLoading = true);
              final response =
              await _apiService.regenerateCode(phone);
              setState(() => _isLoading = false);
              if (response['success'] == true) {
                _showSuccessDialog(
                    "Nouveau code : ${response['code']}");
              } else {
  ...
  InputDecoration _inputDecoration(String label, IconData icon) {
    return InputDecoration(
      ...
      focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(15),
          borderSide: BorderSide(color: _accentTeal, width: 2)),
    );
  }
                            ...
                            children: [
                              ...
                              const Text('NexaTank',
                                  style: TextStyle(
                                      ...
                                      color: Colors.white,
                                      letterSpacing: 1.5)),
                              const Text('La jauge Intelligente',
                                  style:
                              ...
                              const Text('powered by JoshuaDev',
                                  style: TextStyle(
                                      fontSize: 10,
