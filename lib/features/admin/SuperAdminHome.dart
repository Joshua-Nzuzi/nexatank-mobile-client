...
class _SuperAdminHomeState extends State<SuperAdminHome> {
  ...
  final Color _darkBg = const Color(0xFF000000);
                  ...
                  return ElevatedButton(
                    ...
                    child: AnimatedSwitcher(
                      ...
                      child: isProcessing
                          ...
                          : const Text("CALCULER", key: ValueKey('calc_text_sa'), style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
                    ),
                  );
                }),
              ],
  ...
  Widget _buildActionButton(String label, IconData icon, VoidCallback onTap) {
    return Expanded(child: InkWell(onTap: onTap, child: Container(
      ...
      child: Column(children: [Icon(icon, color: _accentTeal, size: 18), const SizedBox(height: 4), Text(label, style: const TextStyle(color: Colors.white, fontSize: 8, fontWeight: FontWeight.bold))]),
    )));
  }
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
                      ...
                      _buildCommandStat("STOCK TOTAL", "${totalVol.toInt()} L", Icons.analytics, _accentTeal),
                    ]),
                  ),
                ),
                Expanded(
